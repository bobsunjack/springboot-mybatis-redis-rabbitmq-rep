...
public class MyBatisConfig {
	...
	public SqlSessionFactoryBean sqlSessionFactoryBean() throws Exception{
        ...
        // 设置别名包
        sqlSessionFactoryBean.setTypeAliasesPackage("cn.wcj.springboot.mybatis.pojo.po");
        //设置Mapper.xml文件的位置
        Resource[] mapperLocations = resolver.getResources("classpath:mybatis/cn/wcj/springboot/mybatis/mapper/*.xml");
